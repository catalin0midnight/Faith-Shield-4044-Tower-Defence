namespace ThirdPixelGames.MenuBuilder
{
    ...
    public class Menu : MonoBehaviour
    {
        ...
        private void OnDisable()
        {
            ...
            ReInput.players.GetPlayer(0).RemoveInputEventDelegate(OnMenuUp);
            //_input.onMenuDown.RemoveListener(OnMenuDown);
            ReInput.players.GetPlayer(0).RemoveInputEventDelegate(OnMenuDown);
        ...
        private void OnEnable()
        {
            ...
            // Add input listeners
            ReInput.players.GetPlayer(0).AddInputEventDelegate(OnMenuUp, UpdateLoopType.Update);
            //_input.onMenuUp.AddListener(OnMenuUp);
            ReInput.players.GetPlayer(0).AddInputEventDelegate(OnMenuDown, UpdateLoopType.Update);
        ...
        /// </summary>
        private void OnMenuUp(InputActionEventData data)
        {
        ...
        /// </summary>
        private void OnMenuDown(InputActionEventData data)
        {
            // Check if the menu is vertical
            if (menuStyle != MenuStyle.Vertical)
            {

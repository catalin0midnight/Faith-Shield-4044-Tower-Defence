...
namespace TDTK{
	...
	public class UITooltip : UIScreen {
		...
		void Update(){
			if(minHeight<=0) rectT.sizeDelta=new Vector2(rectT.sizeDelta.x, 45+rectName.sizeDelta.y+rectDesp.sizeDelta.y);
			else rectT.sizeDelta=new Vector2(rectT.sizeDelta.x, Mathf.Max(minHeight, 45+rectName.sizeDelta.y+rectDesp.sizeDelta.y));
		}
